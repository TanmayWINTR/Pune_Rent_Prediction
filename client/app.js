  ...
  function onClickedEstimatePrice() {
    ...
    //var url = "http://127.0.0.1:5000/predict_home_rent"; //Use this if you are NOT using nginx 
    var url = "/api/predict_home_rent"; // Use this if  you are using nginx.
  
    $.post(url, {
        newadd: location.value,
        bedroom: bhk,
        bathrooms: bathrooms,
    ...
    function(data, status) {
        ...
        estPrice.innerHTML = "<h2>Rs." + data.estimated_rent.toString() + "</h2>";
        console.log(status);
    });
  }
